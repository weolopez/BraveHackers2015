...
// add list of directives into tags
...
(function (window, document) {
  ...
  var tags = [ "ngInclude", "ngPluralize", "ngView", "ngSwitch","accordion","accordionGroup","accordionHeading","attAlert","attCrumb","attDevNotes",
               "attTabs","floatingTabs","simplifiedTabs","attMessages","modalBackdrop","modalWindow","simpleModal","attPagination","attSlider","attSliderMin","attSliderMax","steptracker","attTable",
               "tagBadges","tooltipPopup","attFileLink","verticalSteptracker","verticalSteptrackerStep","attAbsLink","profileCard","attHourpickerOption","attHourpicker","attDrawer","parentTab","parentmenuTabs","menuTabs"];
